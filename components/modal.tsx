...
const Modal = ({excerpt}: {excerpt: string}) => {
        ...
        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div className="sm:flex sm:items-start">
            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              <h3 className="text-base font-semibold leading-6 text-gray-900" id="modal-title">You need to login</h3>
              <div className="mt-2">
                <p>{excerpt}</p>
                <p className="text-sm text-gray-500">This is a premium article, please log in to view it.</p>
              </div>
            </div>
          </div>
        </div>
